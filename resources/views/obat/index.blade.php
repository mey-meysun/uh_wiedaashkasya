        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <a href="{{ route('obat.create') }}" class="inline-block bg-green-500 text-black px-4 py-2 rounded mb-4 hover:bg-green-600">Tambah Obat</a>
                        ...
                        <table class="min-w-full bg-white border border-gray-300">
                            <thead>
                                <tr class="bg-gray-100 text-left">
                                    ...
                                    <th class="py-2 px-4 border-b">Pabrik</th>
                            ...
                            <tbody>
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="text-center">
                                        <img src="{{ asset('/storage/'.$item->gambar) }}" class="rounded" style="width: 150px">
                                    </td>
